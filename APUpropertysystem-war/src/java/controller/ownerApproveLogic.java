...
public class ownerApproveLogic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                towner.setStatus("Approved");
                sendMail(towner.getGmail() , "Your Owner Account Has Been Approved! Stay Updated With The Account Through This Mail.");
                ...
                if (!(sysO.isEmpty())) {
                    ...
                    if (fsysO.isEmpty()) {
                        errorInput = "No Pending Approval";
                        throw new Exception();
                    }
