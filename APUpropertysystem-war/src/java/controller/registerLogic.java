        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (role.equals("Owner")) {
                    ...
                    if (sysO == null) {
                        sendMail(gmail, "You Have Registered For An Owner Account. Stay Updated With The Account Through This Mail.");
                        ...
                        systemOwnerFacade.create(new systemOwner(name, gender, contact, address, age, 0, password, LocalDate.now(), "Pending", gmail));

                        request.getRequestDispatcher("register.jsp").include(request, response);
                        out.println("<br/><br/><h6>Owner Account Registration Request Submitted</h6>");
                    } else {
                    ...
                    if (sysC == null) {
                        ...
                        //String id, char gender, String contact, String address, int age, float balance, String password, LocalDate DOC
                    ...
                    if (sysA == null) {
                        sendMail(gmail, "You Have Registered An Admin Account. Stay Updated With The Account Through This Mail.");
                        //String id, char gender, String contact, String address, int age, String password, LocalDate DOC
