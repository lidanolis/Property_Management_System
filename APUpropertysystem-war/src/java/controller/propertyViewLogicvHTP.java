...
public class propertyViewLogicvHTP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        name = (String) htps.getAttribute("name");
        role = (String) htps.getAttribute("role");
        propName = (String) htps.getAttribute("propName");
        propType = (String) htps.getAttribute("propType");
        propDur = (String) htps.getAttribute("propDur");
        priceRange = (String) htps.getAttribute("priceRange");
        propPrice = (String) htps.getAttribute("propPrice");
        propStatus = (String) htps.getAttribute("propStatus");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                if (allProp.isEmpty()) {
                    errorInput = "The System Has Yet To Have Any Property";
                    throw new Exception();
                }
